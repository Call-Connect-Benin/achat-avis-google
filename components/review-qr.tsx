  ...
  return (
    <div className="grid gap-8 md:grid-cols-2">
      <div className="space-y-5">
        ...
        {reviewLink && !error && (
          <div>
            <p className="text-sm font-medium text-slate-700">Lien à partager</p>
            <code className="mt-1 block break-all rounded-lg bg-slate-100 px-3 py-2 text-xs text-slate-700">
              {reviewLink}
            </code>
            {shareText && (
      ...
      <div className="flex flex-col items-center justify-start">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          {qr ? (
            ...
            <div className="grid h-[240px] w-[240px] place-items-center rounded-xl bg-slate-100 text-center text-sm text-slate-400">
