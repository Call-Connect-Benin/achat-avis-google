  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-10 rounded-2xl bg-sky-50 p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link
              ...
              className="rounded-full border border-sky-300 bg-white px-5 py-2 text-sm font-semibold text-slate-700 transition-colors hover:bg-sky-50"
            >
              Audit de fiche
            </Link>
          </div>
      ...
      <AnimatedSection delay={0.4}>
        <div className="mt-10 flex flex-col items-center gap-3 rounded-2xl bg-slate-900 p-6 text-center sm:flex-row sm:justify-between">
          <p className="font-semibold text-white">
            Prêt à collecter vos premiers avis {isVille ? `à ${name}` : `en tant que ${name.toLowerCase()}`} ?
          </p>
          <Link
            href="/tarifs"
            className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition-colors hover:bg-slate-100"
          >
