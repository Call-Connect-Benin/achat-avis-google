              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-sky-100">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <span className="inline-flex items-center gap-1 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-sky-700 backdrop-blur-sm">
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <div className="mt-auto pt-4 flex items-center gap-2 text-sm font-semibold text-sky-600">
                    Voir l'étude de cas
